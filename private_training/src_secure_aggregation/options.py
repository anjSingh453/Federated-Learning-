...
def args_parser():
    ...
    parser.add_argument('--noise_multiplier', type=float, default=1., help='DP NOISE_MULTIPLIER')
    parser.add_argument('--delta', type=float, default=1e-5, help='DP DELTA')
    parser.add_argument('--virtual_batch_size', type=int, default=64, help='DP VIRTUAL_BATCH_SIZE')
    parser.add_argument('--smpc', type=bool, default=False, help='State if secure multiparty computation\
