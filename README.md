...
Also implements a federated learning framework for classifying diabetic retinopathy stages from retinal fundus images. Instead of centralizing sensitive medical data, we train models locally across multiple simulated hospitals and aggregate model updates securely.
